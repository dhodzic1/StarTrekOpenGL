...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "FinalProjectEnterprise", NULL, NULL);
    if (window == NULL)
    {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ourShader.setVec3("light.position", 0.103f, 2.31216f, -0.28318f);
        ourShader.setVec3("viewPos", camera.Position);

        // light properties
        ourShader.setVec3("light.ambient", 0.3f, 0.3f, 0.4f);
        ourShader.setVec3("light.diffuse", 0.6f, 0.6f, 0.9f);
